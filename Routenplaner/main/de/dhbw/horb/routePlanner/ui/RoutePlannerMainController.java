...
/**
 * Controller-Klasse für die Hauptanwendung. Stellt Funktionen der einzelnen
 * JavaFX-Komponenten zur Verfügung.
 *
 * @author robin
 *
 */
public class RoutePlannerMainController {
	...
	/**
	 * Löst die Berechnung der Route sowie die Anzeige des Ergebnisses aus.
	 * Verursacht Fehler wenn Berechnung aufgrund der Eingabe nicht möglich ist.
	 *
	 * @param event
	 */
	@FXML
	 ...
	 * @param name
	 *            Name des in die Karte eingefügten Layers, der die Markierungen
	 *            enthält
	 * @param colorString
