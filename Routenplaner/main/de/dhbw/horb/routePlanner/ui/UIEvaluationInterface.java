...
/**
 * Schnittstelle zwischen der GUI und den einzelnen Klassen zur Berechnung einer
 * Route.
 *
 * @author robin
 *
...
public class UIEvaluationInterface {
	...
	/**
	 * Methode, die die Berechnung der Route mit dem gewählten Algorithmus
	 * auslöst und nach Berechnung das Ergebnis für die GUI aufbereitet.
	 *
	 * @param departure
