...
public interface Constants {
	...
	public final static String ROUTEPLANNER_POPUP_COLOR_CHANGED = "Sie müssen erneut eine Route berechnen lassen, damit diese Änderung wirksam wird.";
	public final static String ROUTEPLANNER_POPUP_DATA_UPDATE = "Das Aktualisieren der den Berechnungen zugrunde liegenden Daten kann sehr lange dauern. Trotzdem aktualisieren?";
