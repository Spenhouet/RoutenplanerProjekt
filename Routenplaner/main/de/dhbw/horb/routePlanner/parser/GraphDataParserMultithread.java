...
public class GraphDataParserMultithread implements GraphDataConstants {
	...
	public class fillGUI implements Runnable{
		...
		public void run() {
			try {
				GraphDataParser.getGraphDataParser(CONST_XML_NODE_HIGHWAY).everyNodeToGui(gui);
				GraphDataParser.getGraphDataParser(CONST_XML_WAY_HIGHWAY).everyWayToGui(gui);
